...
public:
  ...
  public:
    ...
    Builder& enable_aaabcoalescing(bool enable_aaabcoalescing_)
    {
      m_enable_aaabcoalescing = enable_aaabcoalescing_;
      return *this;
    }
  };
